...
ALTER TABLE TB_DEMANDA_TAREFA
  ...
  ALTER TABLE TB_DEMANDA_TAREFA
  ADD CONSTRAINT pk_demanda_tarefa PRIMARY KEY (id)
  
alter table TB_DEMANDA_LISTA_ATIVIDADE add column data_inicio date;

alter table TB_DEMANDA_TAREFA add column usu_inclusao integer;
alter table TB_DEMANDA_TAREFA add column data_inclusao date;